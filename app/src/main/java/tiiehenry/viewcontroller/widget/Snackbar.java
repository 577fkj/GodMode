package tiiehenry.viewcontroller.widget;
...
public final class Snackbar {
    ...
    public static Snackbar make(@NonNull Activity container, @NonNull CharSequence text, int duration) {
        ...
        ViewGroup parent = container.findViewById(android.R.id.content);
    ...
    public Snackbar setAction(CharSequence text, final View.OnClickListener listener) {
        final TextView tv = view.findViewById(R.id.snackbar_action);
